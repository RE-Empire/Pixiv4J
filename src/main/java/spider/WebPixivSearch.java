...
public class WebPixivSearch implements PageProcessor {
...
//                String s = StringUtils.substringBetween(jsonArray.getJSONObject(i).toString(), "\"large\":\"", "\""); //~60ms
                String s = jsonArray.getJSONObject(i).getJSONObject("image_urls").getString("large");//~40+ms
    ...
    public static void main(String[] args) {
        ...
        Spider.create(new WebPixivSearch())
                .addUrl("https://api.imjad.cn/pixiv/v1/?type=search&word=%E6%98%8E%E6%97%A5%E6%96%B9%E8%88%9F&mode=tag&per_page=20")
                .thread(1)
                .run();
    }
